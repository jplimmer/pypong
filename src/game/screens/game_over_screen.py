...
class GameOverScreen:
    ...
    def render(self, screen, winner, scores):
        ...
        # Game over text
        game_over_text = self.title_font.render(f"GAME OVER - {winner} wins!", True, Colors.GREEN)
        ...
        restart_text = self.menu_font.render("Press SPACE to restart", True, Colors.WHITE)
